...
<?php if($EXT['wap_enable']) { ?><li class="h_wap"><a href="<?php echo $EXT['wap_url'];?>mobile.php">手机版</a>&nbsp;</li><?php } ?>
<?php if($MODULE['16']) { ?><li class="h_cart"><a href="<?php echo $MODULE['16']['linkurl'];?>cart.php" rel="nofollow">购物车</a>(<span class="head_t" id="destoon_cart">0</span>)</li><?php } ?>
</ul>
</div>
</div>
</div>
