...
<td width="25">&nbsp;<input type="checkbox" id="check_<?php echo $t['itemid'];?>" name="itemid[]" value="<?php echo $t['itemid'];?>" onclick="sell_tip(this, <?php echo $t['itemid'];?>);"/> </td>
        <td width="90"><div><a href="<?php echo $t['linkurl'];?>" target="<?php echo $target;?>"><img src="<?php echo $t['thumb'];?>" width="80" height="80" alt="<?php echo $t['alt'];?>" onmouseover="img_tip(this, this.src);" onmouseout="img_tip(this, '');"/></a></div></td>
<td width="10"> </td>
<td align="left">
<ul>
                <li><a href="<?php echo $t['linkurl'];?>" target="<?php echo $target;?>"><strong class="px14"><?php echo $t['title'];?></strong></a></li>
<li>
...
<a href="<?php echo userurl($t['username']);?>" target="<?php echo $target;?>"><?php echo $t['company'];?></a>
</li>
</ul>
</td>
<td class="list_price">￥<strong><?php echo $t['price'];?></strong></td>
<td class="list_count">总共成交<?php echo $t['orders'];?>笔
            <br/><a href="<?php echo $t['linkurl'];?>#comment" target="<?php echo $target;?>"><span><?php echo $t['comments'];?>条评价</span></a></td>
</tr>
</table>
</div>
<?php } } ?>
