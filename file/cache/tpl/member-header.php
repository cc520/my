...
<ul>
<li class="side_a" onmouseover="v(this.id);" onmouseout="t(this.id);" id="booking"><span class="f_r"><a href="booking.php?action=order" class="m">预约</a></span><a href="booking.php" class="<?php if($MG['inbox_limit']>-1) { ?>n<?php } else { ?>f<?php } ?>
">我要预约</a><?php if($_message) { ?><em><?php echo $_message;?></em><?php } ?>
</li>
