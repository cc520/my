...
if(window.location.href.indexOf('<?php echo DT_DOMAIN;?>') != -1){document.domain = '<?php echo DT_DOMAIN;?>';}
<?php } ?>
</script>
...
var links = '';
var texts = '';
document.write('<embed src="<?php echo DT_PATH;?>file/flash/slide.swf" wmode="opaque" FlashVars="config='+config+'&bcastr_flie='+files+'&bcastr_link='+links+'&bcastr_title='+texts+'&menu="false" quality="high" width="<?php echo $bannerw;?>" height="<?php echo $bannerh;?>" type="application/x-shockwave-flash" extendspage="http://get.adobe.com/flashplayer/"></embed>');
</script>
