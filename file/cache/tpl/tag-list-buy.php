...
<td align="left">
<ul>
<li><?php if($t['vip']) { ?><span class="f_r"><img src="<?php echo DT_SKIN;?>image/vip_<?php echo $t['vip'];?>.gif" alt="<?php echo VIP;?>" title="<?php echo VIP;?>:<?php echo $t['vip'];?>¼¶"/></span><?php } ?>
...
<span class="f_gray">&nbsp;&nbsp;<?php if(!$t['username']) { ?> [Î´×¢²á]<?php } ?>
</span>
</li>
</ul>
</td>
