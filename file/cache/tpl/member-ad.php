...
<tr>
<td class="tab" id="add"><a href="ad.php?action=add"><span>广告预定</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="s3"><a href="ad.php"><span>已通过</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="s2"><a href="ad.php?status=2"><span>审核中</span></a></td>
</tr>
</table>
</div>
<?php if($action == 'add') { ?>
